...
class PointNet():
    ...
    def get_model(self, point_cloud, is_training, bn_decay=None):
        ...
        with tf.compat.v1.variable_scope('transform_net1', reuse=tf.compat.v1.AUTO_REUSE) as sc:
        ...
        with tf.compat.v1.variable_scope('transform_net2', reuse=tf.compat.v1.AUTO_REUSE) as sc:
